...
class SubCard extends Component {
    ...
    return (
        ...
        {Object.keys(subscription).map(key => (
            ...
            <a href ={subscription[0].url} key={key}>

            {subscription[key].type}
            <img src={subscription[0].image} key={key}  width="148px" height="100px"/>

      </a>
            <p>{subscription[0].amount}/month</p>
            <p>Subcription renews on: {subscription[0].renewal_date}</p>
